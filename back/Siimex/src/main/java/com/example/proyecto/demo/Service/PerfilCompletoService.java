        ...
        try {
            ...
            try {
                if (datos.get("areaNombre") != null && !datos.get("areaNombre").toString().isBlank()) {
                    ...
                    self.guardarAreaConocimientoConTransaccion(usuarioFinal, datos);
                }
            } catch (Exception e) {
            ...
            try {
                if (datos.get("instNombre") != null && !datos.get("instNombre").toString().isBlank()) {
                    ...
                    self.guardarInstitucionConTransaccion(usuarioFinal, datos);
                }
            } catch (Exception e) {
            ...
            try {
                ...
                if (academicaJsonStr != null && !academicaJsonStr.isBlank()) {
                    ...
                    self.guardarTrayectoriaAcademicaDesdeJsonConTransaccion(usuarioFinal, academicaJsonStr);
                } else if (datos.get("acadTitulo") != null && !datos.get("acadTitulo").toString().isBlank()) {
                    log.info(">>> Guardando trayectoria académica");
                    self.guardarTrayectoriaAcademicaConTransaccion(usuarioFinal, datos);
                }
            } catch (Exception e) {
            ...
            try {
                if (datos.get("trayProfNombramiento") != null && !datos.get("trayProfNombramiento").toString().isBlank()) {
                    ...
                    self.guardarTrayectoriaProfesionalConTransaccion(usuarioFinal, datos);
                }
            } catch (Exception e) {
            ...
            try {
                ...
                if (estanciasJsonStr != null && !estanciasJsonStr.isBlank()) {
                    ...
                    self.guardarEstanciasDesdeJsonConTransaccion(usuarioFinal, estanciasJsonStr);
                    ...
                    self.guardarEstanciaConTransaccion(usuarioFinal, datos);
                }
            } catch (Exception e) {
            ...
            try {
                ...
                if (cursosJsonStr != null && !cursosJsonStr.isBlank()) {
                    ...
                    self.guardarCursosDesdeJsonConTransaccion(usuarioFinal, cursosJsonStr);
                } else if (datos.get("cursoNombre") != null && !datos.get("cursoNombre").toString().isBlank()) {
                    log.info(">>> Guardando curso");
                    self.guardarCursoConTransaccion(usuarioFinal, datos);
                }
            } catch (Exception e) {
            ...
            try {
                ...
                if (congresosJsonStr != null && !congresosJsonStr.isBlank()) {
                    ...
                    self.guardarCongresosDesdeJsonConTransaccion(usuarioFinal, congresosJsonStr);
                    ...
                    self.guardarCongresoConTransaccion(usuarioFinal, datos);
                }
            } catch (Exception e) {
            ...
            try {
                ...
                if (divulgacionesJsonStr != null && !divulgacionesJsonStr.isBlank()) {
                    ...
                    self.guardarDivulgacionesDesdeJsonConTransaccion(usuarioFinal, divulgacionesJsonStr);
                } else if (datos.get("divulgTitulo") != null && !datos.get("divulgTitulo").toString().isBlank()) {
                    log.info(">>> Guardando divulgación individual");
                    self.guardarDivulgacionConTransaccion(usuarioFinal, datos);
                }
            } catch (Exception e) {
            ...
            try {
                ...
                if (articulosJsonStr != null && !articulosJsonStr.isBlank()) {
                    ...
                    self.guardarArticulosDesdeJsonConTransaccion(usuarioFinal, articulosJsonStr);
                } else if (datos.get("artTitulo") != null && !datos.get("artTitulo").toString().isBlank()) {
                    log.info(">>> Guardando artículo individual");
                    self.guardarArticuloConTransaccion(usuarioFinal, datos);
                }
            } catch (Exception e) {
            ...
            try {
                ...
                if (logrosJsonStr != null && !logrosJsonStr.isBlank()) {
                    ...
                    self.guardarLogrosDesdeJsonConTransaccion(usuarioFinal, logrosJsonStr);
                } else if (datos.get("logroNombre") != null && !datos.get("logroNombre").toString().isBlank()) {
                    log.info(">>> Guardando logro individual");
                    self.guardarLogroConTransaccion(usuarioFinal, datos);
                }
            } catch (Exception e) {
            ...
            try {
                if ((datos.get("interesDescripcion") != null && !datos.get("interesDescripcion").toString().isBlank()) || 
                    ...
                    self.guardarInteresHabilidadConTransaccion(usuarioFinal, datos);
                }
            } catch (Exception e) {
