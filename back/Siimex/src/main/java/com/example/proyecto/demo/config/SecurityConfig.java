    ...
    public SecurityFilterChain api(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/convocatorias", "/convocatorias/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/convocatorias", "/api/convocatorias/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/configuracion/limites-pdf").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/configuracion/limites-pdf").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/instituciones-educativas/activas").permitAll()
